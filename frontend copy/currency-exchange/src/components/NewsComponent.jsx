...
const NewsComponent = () => {
  ...
  useEffect(() => {
    axios.get('https://newsapi.org/v2/top-headlines?country=us&apiKey=3a14f73331364bbd868d46549ce0086e')
    ...
    <div className="container mx-auto p-4">
      ...
      {viewMode === 'cards' ? (
        ...
        <ul>
          {articles.map((article, index) => (
            <a href={article.url}>
            <li key={index} className="mb-4 h-24 shadow-md rounded-3xl">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  {article.description ? `${article.description.slice(0, 100)}${article.description.length > 100 ? '...' : ''}` : 'Read More Here'}
                  </p>
